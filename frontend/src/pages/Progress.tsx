        ...
        <div className="min-h-screen bg-[#f8fafc] font-sans pb-20 overflow-x-hidden">
            ...
            <main className="max-w-[1200px] mx-auto px-6 pt-16 space-y-16">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                    <Card className="p-10 border-none shadow-sm bg-white rounded-[3rem] relative overflow-hidden group">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        {interviewHistory.map((item, i) => (
                            <Card key={i} className="p-8 border-none shadow-sm bg-white rounded-[2.5rem] space-y-6 group hover:shadow-xl hover:shadow-rose-100/30 transition-all">
                ...
                {/* Footer Insight */}
                <Card className="p-10 border-none shadow-2xl shadow-blue-100/50 bg-white rounded-[3rem] flex flex-col md:flex-row items-center gap-10">
