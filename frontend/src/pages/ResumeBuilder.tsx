                ...
                <AnimatePresence mode="wait">
                    {step === 'selection' && (
                        ...
                        >
                            <div className="space-y-6">
                                <div className="w-20 h-20 bg-[#5c52d2]/10 rounded-[2rem] flex items-center justify-center mx-auto mb-8 shadow-inner">
                                    <FileText className="w-10 h-10 text-[#5c52d2]" />
                                </div>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid md:grid-cols-2 gap-8">
                                    <button
                                        ...
                                        className="bg-white p-10 rounded-[3rem] shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all border-2 border-transparent hover:border-[#5c52d2]/20 group text-center space-y-6"
                                    >
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <p className="text-gray-400 font-medium text-sm px-4">Upload your existing resume for analysis</p>
                                        </div>
                                    </button>

                                    <button
                                        onClick={() => setStep('builder')}
                                        className="bg-white p-10 rounded-[3rem] shadow-sm hover:shadow-xl hover:scale-[1.02] transition-all border-2 border-transparent hover:border-red-100 group text-center space-y-6"
                                    >
                    ...
                    {step === 'builder' && (
                        ...
                        >
                            ...
                            <Card className="border-none shadow-xl bg-white rounded-[3rem] p-12">
                                <AnimatePresence mode="wait">
                                    {builderStep === 1 && (
                    ...
                    {step === 'upload' && (
                        ...
                        >
                            <div className="text-center space-y-6">
                                ...
                                <h1 className="text-5xl font-black text-gray-900 tracking-tight leading-tight">Upload Your Resume</h1>
                                <p className="text-gray-400 text-lg font-medium">Upload your existing resume and let our AI analyze your skills, experience, and qualifications</p>
                            </div>

                            <div className="relative border-2 border-dashed border-gray-200 rounded-[3rem] p-16 text-center group hover:border-[#5c52d2]/50 transition-all bg-white shadow-sm overflow-hidden">
                                <input
                                    type="file"
                                    accept=".pdf"
